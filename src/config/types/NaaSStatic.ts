...
export interface NaaSStaticInterface extends utils.Interface {
  functions: {
    ...
    "transferWithFeesExact(bytes,address[7],uint8[2],uint256[6],bytes,bytes)": FunctionFragment;
  };
  ...
  encodeFunctionData(
    functionFragment: "transferWithFeesExact",
    values: [
      BytesLike,
      string[],
      [BigNumberish, BigNumberish],
...
export interface NaaSStatic extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: NaaSStaticInterface;

...
import type { NaaSStatic, NaaSStaticInterface } from "../NaaSStatic";
...
export class NaaSStatic__factory {
  static readonly abi = _abi;
  static createInterface(): NaaSStaticInterface {
    return new utils.Interface(_abi) as NaaSStaticInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): NaaSStatic {
    return new Contract(address, _abi, signerOrProvider) as NaaSStatic;
  }
}

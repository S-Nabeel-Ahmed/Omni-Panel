...
import type {
  PSIProxyRegistry,
  PSIProxyRegistryInterface,
} from "../PSIProxyRegistry";
...
export class PSIProxyRegistry__factory {
  static readonly abi = _abi;
  static createInterface(): PSIProxyRegistryInterface {
    return new utils.Interface(_abi) as PSIProxyRegistryInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): PSIProxyRegistry {
    return new Contract(address, _abi, signerOrProvider) as PSIProxyRegistry;
  }
}
